    ...
    data() {
      ...
      return {
        ...
        //   {unit:'國立成功大學歷史系教授兼副校長',url:'https://radb.ncku.edu.tw/Personal_Report/profile.php?s=ODUwODA1NCA7YWxsOzsxO3BlcnNvbmFsX3JlcG9ydF9jc3NfMQ==',name:'陳玉女',ename:'Yuh-Neu Chen',img:'陳玉女.png',field:'明代社會史、明代佛教史、中國佛教史',cv1:'日本國立九州大學東洋史學博士',cv2:'主持人Moderator'},
          ...
          {unit:'中央研究院臺灣史研究所副研究員',url:'https://www.ith.sinica.edu.tw/members_faculty_look.php?l=c&no=3&id=76&page=1&ps=30',name:'吳叡人',ename:'Rwei-ren Wu',img:'吳叡人.png',field:'比較政治、政治理論、亞洲民族主義研究、台灣政治史、台灣政治思想史、日本近現代政治史、日本近現代政治思想史',cv1:'美國芝加哥大學政治學博士',cv2:'發表人Presenter'},
