    ...
    data() {
      ...
      return {
        ...
        activityList2025: [    
          ...
          {unit:'英國倫敦大學亞非學院臺灣研究中心研究員',url:'https://www.soas.ac.uk/about/ming-yeh-rawnsley',name:'蔡明燁',ename:'Ming-yeh T. Rawnsley',img:'蔡明燁.png',field:'Taiwan cinema, Taiwan media & democratization, Taiwan studies',cv1:'英國里茲大學傳播研究所博士',cv2:'主持人Moderator'},
          ...
          {unit:'國立臺灣師範大學臺灣史研究所教授兼所長',url:'https://www.taih.ntnu.edu.tw/index.php/faculty/',name:'康培德',ename:'Peter Kang',img:'康培德.png',field:'早期臺灣史、原住民史、海洋史、歷史地理、區域研究',cv1:'明尼蘇達大學雙城分校地理學博士',cv2:'與談人Discussant'},
  
          {unit:'國立高雄師範大學臺灣文化與歷史語言研究所副教授兼所長',url:'https://c.nknu.edu.tw/tni/TeacherCorner.aspx?PN=41&Tid=23',name:'吳玲青',ename:'Ling-Ching Wu',img:'吳玲青.png',field:'清代與日治臺灣史研究、清代中國史研究、史料解讀、田野與文獻調查',cv1:'日本東京大學文學博士',cv2:'與談人Discussant'},
  
          {unit:'莫納許大學研究員/澳亞臺灣研究學會副會長',url:'https://mail.google.com/mail/u/2?ui=2&ik=129c6711c4&attid=0.4&permmsgid=msg-f:1796455382085600332&th=18ee4aa6e80d044c&view=att&disp=inline&realattid=f_lv1qhv1r4',name:'黃鈺婷',ename:'Phyllis Yu-ting Huang',img:'黃鈺婷.png',field:'Taiwanese Literature; Literary works by mainlander Taiwanese writers; Taiwanese immigrants ',cv1:'PhD in Chinese Studies, Monash University, Australia',cv2:'發表人Presenter'},
          ...
          {unit:'國立中正大學臺灣文學與創意應用研究所副教授',url:'https://gitlci.ccu.edu.tw/p/406-1067-2981,r555.php?Lang=zh-tw',name:'楊智景',ename:'Ling-Ching Wu',img:'楊智景.png',field:'日本近現代文學、日治時期臺灣文學、旅行文學、台日比較文學',cv1:'日本國立御茶水女子大學人間文化研究科博士',cv2:'與談人Discussant'},
