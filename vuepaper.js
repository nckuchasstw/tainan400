const app = Vue.createApp({
    data(){
      ...
      {title:'「細說臺灣鐵道百年史：火車歷史的軌跡與現況」專題演講',url:'activity02.html',author:'蘇昭旭',img:'230919.jpg',data:"2023.9.19",register:'尚未開放報名'},
      {title:'「臺灣荷治時期的鹿與原住民」專題演講',url:'activity12.html',author:'吳聰敏',img:'0920.jpg',data:"2023.9.20",register:'尚未開放報名'},
      {title:'「從牛車到五分車—來蔗走走」走讀',url:'activity03.html',author:'陳文松、林大偉',img:'0923.jpg',data:"2023.9.23",register:'尚未開放報名'},
      {title:'「迢迢織路：臺南紡織工業 400 年」專題演講',url:'activity13.html',author:'曾繁絹',img:'230927.jpg',data:"2023.09.27",register:'尚未開放報名'},
      {title:'「重塑被邊緣的歷史—全球史視角的台語影視發展史」專題演講',url:'activity04.html',author:'蘇致亨',img:'231004.jpg',data:"2023.10.4",register:'尚未開放報名'},
      {title:'鬥鬧熱走唱隊',url:'',author:'鬥鬧熱走唱隊',img:'mainposter.jpg',data:"2023.10.14",register:'尚未開放報名'},
      {title:'「府城飲食文化的趣味」專題演講',url:'activity05.html',author:'魚夫',img:'231019.jpg',data:"2023.10.19",register:'尚未開放報名'},
      ...
      // {title:'「步入臺南街屋的時間隧道：探訪城市中的歷史與人文寶藏」走讀',url:'activity07.html',author:'王茗禾、家永實',img:'1124.jpg',data:"2023.11.24",register:'尚未開放報名'},
      {title:'「行走臺南四百年：在一座歷史城市裡的感知、考現與書寫」專題演講',url:'activity06.html',author:'蘇峯楠',img:'231127.jpg',data:"2023.11.27",register:'尚未開放報名'},
      {title:'「發現醫學臺南」走讀',url:'activity08.html',author:'待定',img:'1201.jpg',data:"2023.12.1",register:'尚未開放報名'},
      {title:'「廟宇信仰與府城四百年」專題演講',url:'activity09.html',author:'陳益源',img:'231215.jpg',data:"2023.12.15",register:'尚未開放報名'},
