    ...
    data(){
      ...
      activityList2024: [
        ...
        activityList2025: [   
          ...
          {title:'人權運動的街頭風景',url:'',author:'劉振祥/劉南芳',img:'humanposter.jpg',data:'113.09.16（一）15:00-17:00',location:'成功大學 光復校區 修齊講堂',introduction:'以鏡頭訴說故事，透過鏡頭看見那些在街頭流血、流汗的人們，揮舞著的旗幟或標語，代表的是一個個「無力者」的凝聚。街頭成了歷史必須記錄的地方，那裡有人，有光。'},
          ...
          {title:'「撕開黑幕的光——海內外人權救援暨北美台灣之音」聯展',url:'humanright.html',author:'劉南芳',img:'humanposter.jpg',data:"2024.09.27（五）-09.28（六）",location:'宜蘭 慈林基金會',introduction:'獨裁者築起謊言的高牆、封鎖消息的傳播，政治犯更是禁忌話題。然而卻有一群人前仆後繼，冒著風險進行人權救援，並讓臺灣的真實之聲在海外不斷傳遞。奮不顧身的人們如何再被記憶？縫隙裡的自由如何再被聽見？本次聯展將帶您一同走過海外與島內共同建構的臺灣民主之路。'},

          {title:'《開在壁上的花》戲劇演出',url:'',author:'--',img:'humanposter.jpg',data:'113.09.30（一）15:00-17:00',location:'成功大學 光復校區 鳳凰樹劇場',introduction:'「海島演劇」劇團於 2014 年由林志遠導演創立，致力搬演臺灣本土的人文故事，結合劇場和舞蹈的藝術形式，使在地故事增添詩意色彩。林志遠導演從 受難者生而為人的角度出發，讓觀者感受到白色恐怖對臺灣社會的影響，對過 去這段威權統治的歷史，能激發出不同面向的覺知和判斷，對於他者具有同理 心並能尊重不同的意見。「海島演劇」近年劇作多探討白色恐怖期間，政治受 難者葬送生命或無奈入獄的生命故事，包括 2016 年《愛的記號》，以陳新吉前輩的生命故事為藍本；2017 年《無法囚禁的心靈》，刻畫陳孟和前輩的一生； 2018 年《回憶的華爾滋》，更以三位 1950 年代女性政治受難者丁窈窕、施水環、張常美為主角；2023 年《開在壁上的花—楊國宇、簡國賢、林秋祥》，以政治受難者楊國宇前輩的經歷為中心，延伸述說了簡國賢、林秋祥、陳顯宗、呂沙 棠、施教爐、黃鼎實、簡士性等受難者的故事，展現出白色恐怖時代下的人物 命運及社會寫照。'},
          ...
          {title:'《山川壯麗》',url:'humanright.html',author:'黃勻弦/劉南芳',img:'humanposter.jpg',data:"2024.10.21（一）15:00-17:00",location:'成功大學光復校區修齊講堂',introduction:'小山是一個10歲沉默的台灣小女孩，沒有人試圖關心她每天承受的各種壓力和鬱悶。小山討厭壓抑的自己，也討厭整個大人建構出來的世界。那個真正的小山到底想對大人們說什麼呢？兒童也是無力者的一部分，兒童的聲音由誰來聆聽？透過兒童的角度，更廣地思考無力者與人權議題。'},
          ...
          {title:'唸歌的傳承與創新培',url:'',author:'羅士哲/胡紫雲',img:'humanposter.jpg',data:'113.11.09（二）14:00-16:00',location:'成功大學 光復校區 禮賢樓2樓5450',introduction:'從傳統唸歌仔的表演形式與音樂特色介紹，進而藉由唸歌仔的新創風格展現當代傳統音樂 的保存與創新走向。'},
          ...
          {title:'《戲劇之夜》戲劇演出',url:'',author:'--',img:'humanposter.jpg',data:'113.12.03（二）15:00-18:00、12.04（三）18:00-20:00',location:'成功大學 力行校區 台文講堂',introduction:'戲劇之夜「雖然無力但我們還有劇場」展演活動的呈現方式，將結合臺灣文學系劉南芳老師所開授的「劇本創作與實務」（113-1）課程，以及藝術研究所暨戲劇碩士學位學程胡紫雲老師所開設的「跨領域表演藝術創作實務」（113-1）課程，引導學生從戲劇相關學理基礎的累積，朝向跨域劇場作品的創作展演作為成果。在「跨領域表演藝術創作實務」（113-1）課程中，將與「當代劇場與劇本創作專題」（112-2）課程中修課學生劉宜訢的創作劇本《我們走吧》相結合， 引領學生嘗試以跨領域的創作概念，演出該劇所傳達對於校園體制壓迫的無力經驗。透過表演藝術創作探索全球化下的現代社會體制、藝術跨領域與文化混雜的複雜連動，進一步探討表演藝術與台灣當代社會、歷史、文學、文化、音樂、戲劇、舞蹈及多媒體等之間未來能建構的跨領域創作模式。'},
