const app = Vue.createApp({
    data(){
      ...
      activityList2024: [
        ...
        {title:'「成為臺灣人——島內與海外敘事」國際學術交流研討會',url:'becomingtaiwanese.html',author:'--',img:'https://chass.ncku.edu.tw/var/file/11/1011/img/185978630.jpg',data:"2024.09.24~27",register:'活動尚未開始'},
        ...
        activityList2025: [
          ...
          {unit:'美國加州大學聖塔芭芭拉分校東亞語言及文化研究系教授',url:'activity24.html',name:'Sabine Frühstück',img:'薩賓.png'},
