const app = Vue.createApp({
    data(){
      ...
      writers: [
        { name: '文學臺灣', image: '六大作家-01.png', quote: '葉石濤（1925-2008），臺南出生，1999年獲頒成功大學名譽博士學位。日治時期發表日文小說，展露文采。戰後精讀《紅樓夢》學習中文，1950年代因「知匪不報」罪名被捕，暫停寫作與工作。為生計輾轉教職並從事翻譯。1960年代中期復出後，專注臺灣文學史論，代表作《臺灣文學史綱》影響深遠。葉石濤小說聚焦臺灣族群與歷史，描寫小人物的命運與困境，充滿本土意識。著作包括《西拉雅族的末裔》、《臺灣男子簡阿淘》、《府城瑣憶》等。' },
        { name: '史學臺灣', image: '六大作家-02.png', quote: '江樹生（1935-），臺南玉井出生，曾任成功大學歷史學系客座講座教授，並於2019年獲頒成功大學名譽博士學位。專注早期臺灣史與荷蘭檔案的研究。著有《檔案敘事：早期臺灣史研究論文集》，並編譯《鄭成功和荷蘭人在臺灣的最後一戰及換文締和》、《臺灣史檔案文書目錄（十）》和《熱蘭遮城日誌》等重要文獻。曾於2007年榮獲總統文化獎「百合獎」、2014年榮獲臺南市文化獎。' },
        { name: '文獻臺灣', image: '六大作家-03.png', quote: '何培夫（1954-2022），臺北出生，成功大學歷史學系退休教授，專長於臺灣史、古蹟與文物、碑碣史料的研究，特別在全臺及離島的碑碣史料研究方面享有高度評價，編有《臺灣地區現存碑碣圖誌》全14種16冊。他致力於古蹟文物保存與學術推廣，出版多本有關臺灣文化資產的著作。作為文化保存的推動者，他曾參與創立臺南市文化資產保護協會，並擔任理事長。曾於1999年獲第一屆「傑出臺灣文獻獎──傑出文獻工作獎」。' },
        { name: '文資臺灣', image: '六大作家-04.png', quote: '傅朝卿（1957-），臺南出生，成功大學建築學系名譽教授，長期專注於臺灣近現代建築史與文化資產保存。曾任成功大學建築學系主任及臺南市文化基金執行長，現為行政院文化建設委員會多項審議委員。研究主題涵蓋世界及臺灣近現代建築與文化遺產保存，出版數百篇論文與著作。他四度獲金鼎獎肯定，於2009年榮獲臺灣建築學會「建築文化藝術類獎項」及國際性的「阿爾伯蒂獎」，2019年榮獲臺南文化獎，並於2024年榮獲行政院文化獎。' },
        { name: '生態臺灣', image: '六大作家-05.png', quote: '陳玉峯（1953-），雲林出生，曾任成功大學台灣文學系教授。其著作超過百冊，涵蓋臺灣植被、生態、宗教及哲學領域，代表作有《生態台灣》、《台灣山林與文化反思》等。1991年創立「臺灣生態研究中心」，2002年設立全國首所生態學系暨研究所，並募款興建生態館。2003年獲第二屆總統文化──鳳蝶獎，同年成立「臺灣生態學會」，2021年再任理事長，推動生態研究。' },
        { name: '美學臺灣', image: '六大作家-06.png', quote: '蕭瓊瑞（1955-），澎湖出生，成功大學歷史學系名譽教授。曾於臺灣師範大學、交通大學、臺南大學及成功大學教授臺灣美術史。曾任臺南市政府文化局長、成功大學藝術中心主任及博物館籌備主任等職。擔任多個美術館及基金會的典藏委員和董事，也是文化部重要古物審議委員及國家文化藝術基金會董事。其著作包括《戰後台灣美術史》、《臺南市藝術人才暨團體基本史料彙編》、《島嶼測量：臺灣美術定向》等，對臺灣美術的發展與研究貢獻深遠。' }
    ],
