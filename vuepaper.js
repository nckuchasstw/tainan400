const app = Vue.createApp({
    data(){
      ...
      {title:'Xi Jinping and the Tibet Question: Core Issues, Policies and Its Implication',url:'activity19.html',author:'--',img:'1208.jpg',data:"2023.12.08",register:'尚未開放報名'},
