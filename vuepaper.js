const app = Vue.createApp({
    data(){
      ...
      {title:'「細說臺灣鐵道百年史：火車歷史的軌跡與現況」專題演講',url:'activity02.html',author:'蘇昭旭',img:'0919.jpg',data:"2023.9.19",register:'尚未開放報名'},
      ...
      {title:'「行走臺南四百年：在一座歷史城市裡的感知、考現與書寫」專題演講',url:'activity06.html',author:'蘇峯楠',img:'1127.jpg',data:"2023.11.27",register:'尚未開放報名'},
      {title:'「發現醫學臺南」走讀',url:'activity08.html',author:'待定',img:'1201.jpg',data:"2023.12.1",register:'尚未開放報名'},
      {title:'「廟宇信仰與府城四百年」專題演講',url:'activity09.html',author:'陳益源',img:'121501.jpg',data:"2023.12.15",register:'尚未開放報名'},
      {title:'「臺南400—鎮北百年老廟巡禮」走讀',url:'activity10.html',author:'郭麗桂',img:'1215.jpg',data:"2023.12.15",register:'尚未開放報名'},
