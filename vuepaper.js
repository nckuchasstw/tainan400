const app = Vue.createApp({
    data(){
      ...
      {title:'「從牛車到五分車—來蔗走走」走讀',url:'activity03.html',author:'陳文松、許乃懿、林大偉',img:'20230923.jpg',data:"2023.9.23",register:'開放報名中'},
      {title:'「迢迢織路：臺南紡織工業 400 年」專題演講',url:'activity13.html',author:'曾繁絹',img:'2023092711.jpg',data:"2023.09.27",register:'開放報名中'},
