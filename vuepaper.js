const app = Vue.createApp({
    data(){
      ...
      activityList2024: [
        ...
        activityList2025: [    
          {title:'成為臺灣人——島嶼與海外敘事',url:'https://tainan-400.com/becomingtaiwanese.html',author:'--',img:'0925.jpg',data:'113.09.24-26',location:'成功大學、臺灣歷史博物館、臺灣文學館',introduction:'「成為臺灣人——島嶼與海外敘事」國際學術研討會以「臺灣研究」為主軸，連結海內外從事臺灣研究的單位及學者，藉由交流研討會、參訪、觀摩等方式，共同找出臺灣在地域特色中，包括文化、文學等多元研究面向及未來發展。預期目標希望能陸續出版「國際臺灣研究」系列叢書，並持續與海外學術機構簽訂「學術研究交流協定」，共同推動臺灣與海外臺灣研究交流與合作與合作；如教師與研究者互訪、學生交換，以及舉辦共同研究計畫、研究會議、交換學術資訊及出版刊物等，建立一個海內外臺灣研究多元合作的發展平台。'},

          {title:'「展．望」人社國際前瞻論壇',url:'envision.html',author:'--',img:'展望論壇.jpg',data:"2024.10.18",location:'國立成功大學成功校區總圖書館B1會議廳',introduction:'本次論壇藉由三場次的討論，反思、審視和遙想臺灣的未來。第一場論壇探討「誰的國？誰的家？臺灣公民意識進化論」，回顧臺灣的歷史，檢視過去國家政策失衡所帶來的不公義問題，以期重新思考歷史的痕跡。第二場「身體的失與能：臺灣科技倫理的身體困境與國家處境」，重新思考身體失能中所蘊含的可能性，促進社會關懷，確保尊重每個人的價值和尊嚴，期盼培育更好臺灣現代公民素質，實現社會公平。第三場論壇以「隱匿的手：文化殖民的思想剝奪與國家危機」為主題，聚焦於「未來」的國家想像，探討臺灣新世代在面臨網絡社群媒體的文化殖民挑戰時，如何重新思考臺灣認同，並探索臺灣的未來展望。這三場論壇將透過前瞻性思考和社會上關鍵的議題，例如社會正義、身障正義、原住民正義、教育正義、文化正義等，跨領域地討論臺南四百年後的社會走向。'},
          ...
          {title:'無力者',url:'humanright.html',author:'--',img:'humanposter.jpg',data:"2024.09.24-12.15",location:'國立成功大學',introduction:'本屆藝術節我們以「無力者／Right Said Right」為主軸，展開人權議題的探討與推廣。無力者（むりょくしゃ）為「有力者」（ゆうりょくしゃ）的相對，1924年，辜顯榮、林熊徵為反對臺灣議會設置請願運動，於6月27日下午四時在辜家商行大和行舉辦「全島有力者大會」，認為議會設置請願僅是本島少數人之空想，不能代表全島多數人的聲音。而有力者意為有影響力的、重要的人。隨後，林獻堂等人於7月3日，於全臺北、中、南召開「全島無力者大會」，臺北在「港町文化講座」舉行演講、臺中則於錦町林公祠召開會議，聚集約一千人，表達爭取人道正義與自由的權利。2024年適逢無力者大會百年，取其不畏強權施壓，願與無助大眾站在一起，維護人權正義挺身而出的精神，推廣人權議題。'},
